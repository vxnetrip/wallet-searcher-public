...
class TronWallet(CryptoBase):
    """Wallet class for Tron."""
    def get_private_key(self):
        """Get Litecoin address private key."""
        bip44_mst = Bip44.FromSeed(self.seed, Bip44Coins.TRON)
...
if __name__ == "__main__":
    mnemonic = sys.argv[1]
    tron_wallet = TronWallet(mnemonic)
    tron_address = tron_wallet.generate_address()
